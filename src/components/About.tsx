...
const About = () => {
  const stats = [
    { number: "Launching Soon", label: "Across Major Cities", icon: Package },
    { number: "30min", label: "Avg Delivery", icon: Clock },
    { number: "Crafted With", label: "Parent Feedback", icon: Star },
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground font-comic leading-relaxed">
                We're parents too, and we know how challenging it can be to keep
                kids happy while managing busy schedules. That's why we created
                the fastest way to get everything kids need - from last-minute
                birthday gifts to healthy snacks for school lunches.
              </p>
              <p className="text-lg text-muted-foreground font-comic leading-relaxed">
                Every product is hand-selected by our team of parents and child
                safety experts. No questionable toys, no unhealthy snacks - just
                quality items that kids love and parents trust, delivered in
                minutes.
              </p>
            </div>
